...
export default function ProgrammingFundasAssessment() {
  ...
  useEffect(() => {
    ...
    async function loadQuestions() {
      try {
        const endpoint = `/api/questions?type=TECH_SUITES&category=${encodeURIComponent("Programming Fundas")}&limit=20`;
  ...
  async function handleCompleteAssessment() {
    ...
    try {
      await fetch('/api/sessions/record', {
        ...
        body: JSON.stringify({
          module: "Tech-suites (Programming Fundas)",
    ...
    return (
      <div className="h-screen overflow-hidden bg-zinc-950 flex flex-col items-center justify-center space-y-4 p-6">
        ...
        <p className="text-zinc-400 font-medium">
          No questions populated for Programming Fundas yet.
        </p>
        <button
          onClick={() => router.back()}
          ...
          <div className="max-w-4xl mx-auto space-y-8 pb-24">
            ...
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-zinc-400">
                ...
                <span className="text-purple-400 font-bold">Programming Fundas</span>
              </p>
