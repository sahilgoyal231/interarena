...
// import { XLogo, FacebookLogo, InstagramLogo, LinkedinLogo } from "@phosphor-icons/react/dist/ssr";
  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 text-zinc-100 flex flex-col overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-16 w-full p-6 md:p-12 flex-grow">
        ...
        {/* Hero Section */}
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] xl:grid-cols-[1.3fr_0.7fr] gap-8 items-center pb-8 -mt-4 md:-mt-6">
          <div className="text-left space-y-6 md:space-y-8">
            <h1 style={{ fontFamily: "var(--font-fuzzy-bubbles)" }} className="text-5xl md:text-7xl xl:text-8xl font-black tracking-tighter text-white leading-[1.1]">
            ...
            <Card className="bg-zinc-900/80 backdrop-blur-sm border-zinc-700/60 rounded-3xl hover:border-purple-500/70 hover:bg-purple-900/10 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 flex flex-col h-full cursor-pointer overflow-hidden">
              <CardHeader className="space-y-4 p-8">
                <div className="flex justify-between items-start">
                  <CardTitle className="text-2xl text-white font-bold">Apt-Arena</CardTitle>
            ...
            {(() => {
              ...
              return [
                ...
                return (
                  <div 
                    key={moa.id}
                    className={`group relative flex flex-col justify-between p-6 bg-zinc-900/60 backdrop-blur-md border border-zinc-800/80 rounded-3xl ${theme.borderHover} ${theme.bgHover} hover:shadow-2xl ${theme.glowHover} transition-all duration-500 cursor-pointer overflow-hidden isolate`}
                  >
