...
export default function HldAssessment() {
  ...
  useEffect(() => {
    ...
    async function loadQuestions() {
      try {
        const endpoint = `/api/questions?type=SYSTEM_DESIGN&category=${encodeURIComponent("High Level Design (HLD)")}&limit=20`;
    ...
    return (
      <div className="h-screen overflow-hidden bg-zinc-950 flex flex-col items-center justify-center space-y-4 p-6">
        ...
        <p className="text-zinc-400 font-medium">
          No questions populated for HLD yet.
        </p>
        <button
          onClick={() => router.back()}
          ...
          <div className="max-w-4xl mx-auto min-h-full flex flex-col space-y-8 pb-6">
            ...
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-zinc-400">
                ...
                <span className="text-purple-400 font-bold">High Level Design</span>
              </p>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="p-6 border-b border-zinc-800">
                ...
                <h2 className="text-xl font-bold text-white mb-2">End the draft?</h2>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  ...
                  <br /><br />
                  Are you sure you want to end this draft? You will be taken to your results and won&apos;t be able to submit further answers.
                </p>
              </div>
