...
export default function GlobalError({
  ...
  useEffect(() => {
    // We log the error in production/development cleanly
    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center font-sans p-6 text-center">
      <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 rounded-3xl p-8 space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-black text-white">System Fault Detected</h2>
          <p className="text-zinc-400">An unexpected error occurred in the execution environment.</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <RefreshCcw className="w-4 h-4" /> Restart Protocol
          </button>
