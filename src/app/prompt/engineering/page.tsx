...
export default function PromptEngineeringAssessment() {
  ...
  useEffect(() => {
    ...
    async function loadQuestions() {
      try {
        const endpoint = `/api/questions?type=PROMPTING_AND_LLMS&category=${encodeURIComponent("Prompt Engineering")}&limit=20`;
  ...
  async function handleCompleteAssessment() {
    ...
    try {
      await fetch('/api/sessions/record', {
        ...
        body: JSON.stringify({
          module: "Prompt Engineering Trials",
    ...
    return (
      <div className="h-screen overflow-hidden bg-zinc-950 flex flex-col items-center justify-center space-y-4 p-6">
        ...
        <p className="text-zinc-400 font-medium">
          No questions populated for Prompt Engineering yet.
        </p>
        <button
          onClick={() => router.back()}
          ...
          <div className="max-w-4xl mx-auto min-h-full flex flex-col space-y-8 pb-6">
            ...
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-zinc-400">
                ...
                <span className="text-purple-400 font-bold">Prompt Engineering</span>
              </p>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="p-6 border-b border-zinc-800">
                ...
                <h2 className="text-xl font-bold text-white mb-2">End the trial?</h2>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  ...
                  <br /><br />
                  Are you sure you want to end this trial? You will be taken to your results and won&apos;t be able to submit further answers.
                </p>
              </div>
