...
export const TerminalOutput: React.FC<TerminalOutputProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-[#0d1117] border-l border-zinc-800 text-zinc-300 font-mono text-sm relative overflow-hidden">
      ...
      <div data-lenis-prevent="true" className="flex-1 overflow-y-scroll min-h-0 p-4 space-y-2 custom-scrollbar">
        {isExecuting ? (
          ...
          <>
            ...
            {stderr && (
              <pre className="whitespace-pre-wrap wrap-break-word leading-relaxed text-red-400 font-bold bg-red-500/10 p-3 rounded-lg border border-red-500/20">
                {stderr}
              </pre>
            )}
